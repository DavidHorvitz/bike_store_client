...
export default function Shopping_cart() {
  ...
  useEffect(() => {
    ...
    const newTotalAmount = cart_items.reduce(
      (total, item, index) => total + parseFloat(item.list_price) * quantities[index],
      0
    );
                        ...
                        <div key={index}>
                          ...
                          <MDBRow className="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <MDBCol md="4" lg="2" xl="3" className="text-end">
                              ...
                              <MDBTypography tag="h6" className="mb-0">
                                 €  {(parseFloat(item.list_price) * quantities[index]).toFixed(2)} 
                              </MDBTypography>
                            </MDBCol>
                  ...
                  <MDBCol lg="4" className="bg-grey">
                    <div className="p-5">
                      ...
                      <div className="d-flex justify-content-between mb-4">
                        ...
                        <MDBTypography tag="h5">€ {totalAmount.toFixed(2)}</MDBTypography>
                      </div>
